...
PORTS_STD="asciidoc autoconf automake bison doxygen fop graphviz groff gtk-doc libtool mdbook meson pkgconfig py313-mako py313-setuptools py313-yaml xmlto"
PORTS_CMAKE="cmake"
...
sudo ${BUILD_TOOLS_PREFIX_STD}/bin/port select python3 python313 || die "Could not select python3"
